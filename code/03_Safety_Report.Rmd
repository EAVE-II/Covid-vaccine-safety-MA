...
project_path <- paste0(Location,"EAVE/GPanalysis/progs/SRK/Safety_meta_analysis")
...
for (i in 1:(length(endpoint_groups))) {
...
z_tab <- kableExtra::kbl(z_tab,
 ...
 #               digits=c(NA,NA, 0,0,1,2,2,2,2,2,2),
                col.names = c("Time","N","R","N","R","N","R","N","R") ) %>%
  kableExtra::kable_classic(full_width = F, html_font = "Cambria", position = "left") %>%
  kableExtra::column_spec(2:9, width="6em") %>%
  #kableExtra::column_spec(c(5,8), width="6em") %>%
  kableExtra::add_header_above(c(" " = 1, "England" = 2, "Scotland" = 2, "Wales" = 2, "All"=2))
